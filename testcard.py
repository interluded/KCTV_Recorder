...
predefined_testcard = cv2.imread("predefined_testcard.png", cv2.IMREAD_UNCHANGED)

# Calculate the Mean Squared Error (MSE) between the captured frame and the predefined testcard
try:
    image_difference = mse(image, predefined_testcard)
